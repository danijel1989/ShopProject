...
public class AdminController {
	...
	//==================================== METODE ZA CATEGORY ====================================
	//samu putanju pisati u formatu sa crticama kao u primeru ispod category-list
...
//=================================== PRODUKT =====================================
	...
	public String getProductSave(@ModelAttribute Product product) {
		...
		for(Sticker s: product.getStickers()) {
			
			Sticker tempSticker = stickerDAO.getStickerById(s.getId());
...
//--------------------------------------- USERS pages -----------------------------------------	
	...
	public String getUserForm(Model model) {
		...
		model.addAttribute("userRoles", userDAO.getUserRole());
	...
	public String getChangePasswordSave(@ModelAttribute ChangePassword changePassword, Principal principal, Model model) {
		...
		if(!changePassword.getNewPassword().equalsIgnoreCase(changePassword.getConfirmPassword())) {
			...
			//ako stara lozinka ne odgovara korisniku
