                ...
                <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
                    ...
                    <form:form  action="contact-save" modelAttribute="message" class="contact-form text-uppercase">
                        <div class="form-group">
                            ...
                            <form:input path="name" type="text" name="name" value="" class="form-control" id="contact-name"/>
                            <div class="error-msg"></div>
                        </div>
                        <div class="form-group">
                            <label for="contact-surname">YOUR SURNAME:</label>
                            <form:input path="surname" type="text" name="surname" value="" class="form-control" id="contact-surname"/>
                            <div class="error-msg"></div>
                        </div>
                        <div class="form-group">
                            <label for="contact-email">EMAIL ADDRESS:</label>
                            <form:input path="email" type="email" name="email" value="" class="form-control" id="contact-email"/>
                            <div class="error-msg"></div>
                        </div>
                        <div class="form-group">
                            <label for="contact-message">YOUR MESSAGE:</label>
                            <form:textarea path="message" name="message" class="form-control" id="contact-message"/>
                            <div class="error-msg"></div>
                        </div>
