                            ...
                            <div class="form-group mb-5">
                             ...
                             <c:forEach var="sticker" items="${stickers}">
                                ...
                                <label class="d-flex">
                                    ...
                                    <c:if test="${stickersSelected.contains(sticker.id)}">checked="checked"</c:if>
                                    >
                                    ${sticker.title}
                            ...
                            <div class="col-xxm-6 col-md-4">
                                <article class="popular-products-item mb-2
                                    ...
                                    <figure class="mb-3 d-flex
                                        ...
                                        align-items-center">
                                        <a href="shop-detail/${product.seoTitle}/${product.id}" class="d-block"><img src="${product.image}"
                                                alt="" /></a>
                                    </figure>
                                    <div class="popular-products-details
                                        text-center text-lg-left">
                                        <h5 class="mb-1"><a href="shop-detail/${product.seoTitle}/${product.id}" class="text-uppercase">${product.title}</a></h5>
